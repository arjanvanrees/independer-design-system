<template>
    <NuxtLink v-if="path && !disabled" :to="path" class="
      inline-flex
      justify-center
      rounded-lg
      font-semibold
    ...
    " :class="[classes, loadingClasses, iconOnly]" :disabled="disabled">
        <slot>
            <Icon v-if="icon" :name="icon" class="w-6 h-6 flex-shrink-0 cursor-pointer" :class="{ 'mr-2': label }" />
    ...
    " :class="[classes, loadingClasses, iconOnly]" :disabled="disabled">
        <slot>
            <Icon v-if="icon" :name="icon" class="w-6 h-6 shrink-0 cursor-pointer" :class="{ 'mr-2': label }" />
